namespace _2023._11._16
{
    ...
    {
        public HobGoblin(string name) : base(name, 100) { } // 체력 100
    }
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            HobGoblin hobgoblin = new HobGoblin("HobGoblin"); // 드래곤 생성
            ...
            // 스테이지 2
            Stage stage2 = new Stage(player, hobgoblin, stage2Rewards);
            stage2.Start();
